...
### Added
- Re-added shell argument quoting functionality via quoteArg function
- Proper escaping for arguments with spaces and special shell characters

### Fixed
- Fixed integration tests to avoid double-quoting bash -c commands
- Ensured quoteArg works correctly with environment variable support

### Changed
- Updated integration tests for better compatibility with automatic quoting
